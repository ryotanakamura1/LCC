...
set matsize 11000, permanently
  clear all
	...
	log using log/beforeafter_HH , replace
**#
  foreach het in    aft   bef   {
  global het="H`het'"
...
if "${het}"=="Haft" {
keep if   period==2
global X="  `seg'   age age2 female inc2 inc3 inc4 inc5 inc6 inc7 inc8 inc9 inc10     Asian  White  SELFempl   unemplINACTIVE UNKNWwork     lic  student  dayw_2 dayw_3 dayw_4 dayw_5   YEAR_4 YEAR_5 YEAR_6     MONTHH_2 MONTHH_3 MONTHH_4 MONTHH_5 MONTHH_6 MONTHH_7 MONTHH_8 MONTHH_9 MONTHH_10 MONTHH_11 MONTHH_12 " 
  local G="All, treatment"

}
if "${het}"=="Hbef" {
keep if   period!=2
global X="  `seg'   age age2 female inc2 inc3 inc4 inc5 inc6 inc7 inc8 inc9 inc10   Asian  White  SELFempl   unemplINACTIVE UNKNWwork     lic  student  dayw_2 dayw_3 dayw_4 dayw_5  YEAR_3 YEAR_7 YEAR_8   MONTHH_2 MONTHH_3 MONTHH_4 MONTHH_5 MONTHH_6 MONTHH_7 MONTHH_8 MONTHH_9 MONTHH_10 MONTHH_11 MONTHH_12 " 
